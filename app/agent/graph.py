...
SYSTEM_PROMPT = (
    ...
    "When the user asks to file/create a ticket, terminate a query, or restart a "
    "service, CALL the matching write tool directly — do not merely describe it. "
    "It will pause for human approval before running.\n\n"
